...
public class QQService {
     ...
     */
    private static final String XIAO_V_INTRO = "你好，我是小薇机器人，将我邀请进群就可以开始聊天了~";

    /**
     * XiaoV listener self intro.
     */
    private static final String XIAO_V_LISTENER_INTRO = "你好，我是小薇机器人，将我邀请进群就可以开始聊天了~";

    /**
     * No listener message.
     */
    private static final String NO_LISTENER = "你好，我是小薇机器人，将我邀请进群就可以开始聊天了~";
    ...
    public void onQQGroupMessage(final GroupMessage message) {
    	...
    	System.out.println(new Date() +"   " +message.getContent());
